...
namespace Kata.Spec
{
    ...
    public class when_user_input_is_one_number
    {
        ...
        It should_return_the_same_number = () => { _result.Should().Be(4); };
        private static Calculator _systemUnderTest;
        private static int _result;
    }
    ...
    public class when_input_includes_a_custom_delimiter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
        ...
        It should_use_that_delimiter_to_split_and_return_the_sum = () => { _result.Should().Be(7); };
        private static Calculator _systemUnderTest;
        private static int _result;
    }
